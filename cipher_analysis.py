...
#find most common patterns of n letters length
...
#replace characters with translation guesses. 
...
#run entire process from string cleaning to stats
def all_stats(path):
    #file to string
    ...
    for para in para_dict:
        if para == 0:
            ...
            single_list = frequency(cipher)
        
            #find same repeated characters (tt, ll, ss).
            dup_list = findduplicates(cipher)
            #find most frequent repeated 2-letters .. n-letters.
            patt2 = patterns(cipher, 2)
            patt3 = patterns(cipher, 3)
            patt4 = patterns(cipher, 4)

    return cipher, single_list, dup_list, patt2, patt3, patt4
...
if __name__=='__main__':
    ...
    for para in para_dict:
        ...
        if para == 0:
            ...
            #write_file(savepath, para, str(cipher), "frequencies", freq_list, "duplicates", dup_list, "patt2", patt2, "patt3", patt3, "patt4", patt4, "\n")
